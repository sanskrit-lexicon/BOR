"""Synthetic tests for 08_markup_fix.py (BOR)."""
...
line, n = fix_trim_whitespace("<div> word </div>")
check("<div> trim", line, "<div>word</div>")
check("<div> trim n>=1", n>=1, True)
line, n = fix_trim_whitespace("<div>clean</div>")
check("<div> no-op", line, "<div>clean</div>")
check("<div> no-op n", n, 0)
